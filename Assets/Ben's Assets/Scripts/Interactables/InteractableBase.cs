...
{
    [Header("Prompt")]
    [SerializeField] protected Transform promptAnchor; // optional custom anchor
    ...
    protected virtual bool IsAvailable(GameObject interactor) => true;
    ...
    public virtual bool CanInteract(GameObject interactor)
    {
        ...
        if (!IsAvailable(interactor)) return false;
